<?php
    ...
    ?>
	<div style="background-color:white;display:flex;align-items:center;position:relative;border-bottom:1px solid #666;padding:8px 0;margin:2px 0;"
	    class='movie-item'>
	    <div style="width:10%;">
	    ...
	    <div style="width:80%;">
	        ...
	        <div>
	            <button class="show" data-id="<?php echo $row['id'];?>"><?php echo ($row['sh'] == 1) ? '隱藏' : '顯示';?></button>
	            <button class="sw" data-id="<?php echo $row['id'];?>" data-sw="<?php echo $prev;?>" data-type="up">往上</button>
	            <button class="sw" data-id="<?php echo $row['id'];?>" data-sw="<?php echo $next;?>" data-type="down">往下</button>
